    ...
    public void Mover(int filainicial, int columnainicial, int filafinal, int columnafinal){
        ...
        if(Tablero.turno){
            ...
            if(Tablero.Tablero [filafinal][columnafinal].charAt(1) != 'B' && (Tablero.Tablero[filafinal][columnafinal].charAt(0) == 'P' 
                ...
                if(Tablero.Tablero[filafinal][columnafinal].charAt(0)== 'P'){
                    System.out.println("La Torre de "+Player_Maintenance.jugadorLogged.getUsername()+" se ha comido al Peon de "+Player_Maintenance.jugadorInvitado.getUsername()+" ");
                }else if(Tablero.Tablero[filafinal][columnafinal].charAt(0)=='T'){
                    System.out.println("La Torre de "+Player_Maintenance.jugadorLogged.getUsername()+" se ha comido a la Torre de "+Player_Maintenance.jugadorInvitado.getUsername()+" ");
                }else if(Tablero.Tablero[filafinal][columnafinal].charAt(0) == 'C'){
                    System.out.println("La Torre de "+Player_Maintenance.jugadorLogged.getUsername()+" se ha comido al Caballo de "+Player_Maintenance.jugadorInvitado.getUsername()+" ");
                }else if(Tablero.Tablero[filafinal][columnafinal].charAt(0) == 'A'){
                    System.out.println("La Torre de "+Player_Maintenance.jugadorLogged.getUsername()+" se ha comido al Alfil de "+Player_Maintenance.jugadorInvitado.getUsername()+" ");
                }else if(Tablero.Tablero [filafinal][columnafinal].charAt(0) == 'Q'){
                    System.out.println("La Torre de "+Player_Maintenance.jugadorLogged.getUsername()+" se ha comido a la Dama de "+Player_Maintenance.jugadorInvitado.getUsername()+" ");
        ...
        if((( filafinal < 8) && ( columnafinal <8)) && (Tablero.Tablero[filafinal][columnafinal].equals("--") 
            ...
            if(Tablero.Tablero [filafinal][columnafinal].charAt(1) != 'N' && (Tablero.Tablero[filafinal][columnafinal].charAt(0) == 'P' 
                    ...
                    || Tablero.Tablero[filafinal][columnafinal].charAt(0) == 'K')){
                if(Tablero.Tablero[filafinal][columnafinal].charAt(0)== 'P'){
                    System.out.println("La Torre de "+Player_Maintenance.jugadorInvitado.getUsername()+" se ha comido al Peon de "+Player_Maintenance.jugadorLogged.getUsername()+" ");
                    }else if(Tablero.Tablero[filafinal][columnafinal].charAt(0)=='T'){
                    System.out.println("La Torre de "+Player_Maintenance.jugadorInvitado.getUsername()+" se ha comido a la Torre de "+Player_Maintenance.jugadorLogged.getUsername()+"");
                    }else if(Tablero.Tablero[filafinal][columnafinal].charAt(0) == 'C'){
                    System.out.println("La Torre de "+Player_Maintenance.jugadorInvitado.getUsername()+" se ha comido al Caballo de "+Player_Maintenance.jugadorLogged.getUsername()+" ");
                    }else if(Tablero.Tablero[filafinal][columnafinal].charAt(0) == 'A'){
                    System.out.println("La Torre de "+Player_Maintenance.jugadorInvitado.getUsername()+" se ha comido al Alfil de "+Player_Maintenance.jugadorLogged.getUsername()+" ");
                    }else if(Tablero.Tablero [filafinal][columnafinal].charAt(0) == 'Q'){
                    System.out.println("La Torre de "+Player_Maintenance.jugadorInvitado.getUsername()+" se ha comido a la Dama de "+Player_Maintenance.jugadorLogged.getUsername()+" ");
                    }else if(Tablero.Tablero [filafinal][columnafinal].charAt(0) == 'K'){
